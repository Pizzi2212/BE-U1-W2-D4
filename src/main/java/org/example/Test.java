...
public class Test {
    ...
    public static Map<Customer, List<Order>> orderClients(List<Order> orderList) {
        return orderList.stream()
                .collect(Collectors.groupingBy(Order::getCustomer));
    }

    public static Map<Customer, Double> totalSalesByCustomer(List<Order> orderList) {
        return orderList.stream()
    ...
    public static List<Product> findMostExpensiveProducts(List<Product> productList) {
        OptionalDouble maxPrice = productList.stream()
                .mapToDouble(Product::getPrice)
                .max();

        return maxPrice.isPresent()
                ? productList.stream()
                .filter(product -> product.getPrice() == maxPrice.getAsDouble())
                .collect(Collectors.toList())
    ...
    public static void main(String[] args){
        ...
        salesByCustomer.forEach((customer, total) ->
